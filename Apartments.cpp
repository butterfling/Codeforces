...
int findApartments(vector<int>& applicants, vector<int>& apartments, int k) {
...
void solve() {
    ...
    int ans = findApartments(applicants, apartments, k);
    cout << ans << endl;


    // int n = arr.size();

    // int res = binarySearch(arr,0,n,89);

    // int lowerboundans = lowerbound(arr,15);

    // int upperboundans = upperbound(arr,15);

    // cout<<lowerboundans<<nline;

    // cout<<upperboundans<<nline;
